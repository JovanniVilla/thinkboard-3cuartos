    ...
    <div className="relative min-h-screen flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-base-content/60 text-sm">Crea una cuenta para empezar a organizar</p>
        </div>
        ...
        <div className="bg-base-100/80 backdrop-blur-xl border border-base-content/10 rounded-2xl shadow-2xl p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-xl font-bold text-base-content">Crear Cuenta</h2>
              <p className="text-xs text-base-content/50">Regístrate para empezar</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text font-medium text-base-content/80">Nombre completo</span>
              </label>
              <input
                id="register-name"
                type="text"
            ...
            <button
              id="register-submit"
              type="submit"
              className="btn btn-primary w-full text-base font-semibold shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all mt-2"
              disabled={loading}
            >
              {loading ? (
                <>
